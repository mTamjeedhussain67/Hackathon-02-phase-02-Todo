...
const TaskCardComponent: React.FC<TaskCardProps> = ({
  ...
  if (isEditing) {
    return (
      <motion.div
        ...
        className="bg-card/60 backdrop-blur-lg border border-amber-500/20 rounded-2xl shadow-2xl p-6 sm:p-8"
  ...
  return (
    <motion.div
      ...
      className="bg-card/40 backdrop-blur-md border border-amber-500/10 rounded-2xl shadow-xl hover:shadow-2xl hover:border-amber-500/30 hover:scale-[1.01] transition-all duration-300 p-6 sm:p-8 group"
      data-testid="task-card"
    >
      <div className="flex items-start gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          {showExpandButton && (
            <button
              className="text-sm text-amber-400 hover:text-amber-300 font-medium mb-2"
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            className="w-10 h-10 flex items-center justify-center rounded-lg bg-amber-500/5 border border-amber-500/20 hover:border-amber-500/50 text-amber-400 hover:text-amber-300 transition-all duration-200"
