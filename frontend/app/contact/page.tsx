    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="bg-card border border-primary/10 rounded-xl p-8 sm:p-10 shadow-2xl shadow-black/50"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-card border rounded-lg text-white placeholder-gray-500 focus:outline-none transition-all duration-300 ${isFocused.message
                    ? 'border-primary bg-primary/5 shadow-[0_0_20px_rgba(99,102,241,0.2)]'
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-black border rounded-lg text-white placeholder-gray-500 focus:outline-none transition-all duration-300 ${isFocused.email
                    ? 'border-primary bg-primary/5 shadow-[0_0_20px_rgba(212,175,55,0.2)]'
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-primary text-black px-8 py-3 rounded-lg font-bold hover:bg-primary-light hover:shadow-[0_0_30px_rgba(212,175,55,0.3)] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            <p className="text-gray-text text-sm">
              ...
              <a
                ...
                className="text-primary hover:text-primary-light transition-colors duration-200 underline decoration-primary/40 hover:decoration-primary/70"
              >
                hello@taskify.app
              </a>
            </p>
